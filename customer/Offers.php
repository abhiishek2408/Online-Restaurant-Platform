...
// $sql = "SELECT * FROM menu_sections WHERE Offers = '1' ORDER BY name"; // Replace 'menu_sections' with your table name
$sql = "SELECT * FROM menu_sections WHERE Offers = 1 ORDER BY name";
...
if ($result->num_rows > 0) {
    ...
    echo "<style>
            ...
            .order-button {
                position: absolute; /* Positioning the button above the image */
    ...
    echo "<div class='food-type-heading'>Offers</div>";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        // Button positioned above the image with updated text
